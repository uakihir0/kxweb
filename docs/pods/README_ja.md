...
本レポジトリにはバージョンは存在せず、[kxweb] のバージョンと一致するブランチが存在します。
どのバージョンの [kxweb] を使用するかは、本レポジトリのブランチを指定することで決定します。
[ブランチ一覧](https://github.com/uakihir0/kxweb-cocoapods/branches) からバージョンに対応するブランチを確認してください。
...
詳しい使い方については、[kxweb] の README も合わせて確認してください。
